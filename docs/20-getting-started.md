...
As defined further in the Marco Polo Bank Open Banking API Specification
...
> The request object used in OIDC flows the aud claim is the issuer url from the Marco Polo Bank ASPSP .wellknown endpoint (linked below).
