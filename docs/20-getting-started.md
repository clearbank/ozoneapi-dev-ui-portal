...
As defined further in the Clear Bank  Open Banking API Specification
...
> The request object used in OIDC flows the aud claim is the issuer url from the Clear Bank  ASPSP .wellknown endpoint (linked below).
